      ...
      <div className="product_details">
        ...
        <div>
          <div>
            ...
            <flex>
              <s style={{ color: "grey" }}>
                PKR {Math.ceil(product.price + product.price * 0.1)}
              </s>
              <span style={{ marginLeft: "10px" }}>Save PKR {Math.ceil(product.price * 0.1)} (10.01%)</span>
            </flex>
            <span
              style={{
            ...
            >
              Free shipping on orders above PKR 998
            </span>
